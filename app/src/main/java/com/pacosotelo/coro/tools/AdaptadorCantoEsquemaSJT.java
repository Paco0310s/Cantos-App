...
public class AdaptadorCantoEsquemaSJT extends RecyclerView.Adapter<AdaptadorCantoEsquemaSJT.ViewHolder> {
    private final LayoutInflater mInflater;
    private final Context contexto;
    private List<Canto> listaCantos;

    public AdaptadorCantoEsquemaSJT(List<Canto> listaCantos, Context contexto) {
    ...
    @NonNull
    @Override
    public AdaptadorCantoEsquemaSJT.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_canto_momento, null);
        return new AdaptadorCantoEsquemaSJT.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdaptadorCantoEsquemaSJT.ViewHolder holder, int position) {
