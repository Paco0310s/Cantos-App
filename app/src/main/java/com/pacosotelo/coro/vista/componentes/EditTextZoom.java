...
public class EditTextZoom extends androidx.appcompat.widget.AppCompatEditText {
	...
	public EditTextZoom(Context context, AttributeSet attrs) {
	...
	public EditTextZoom(Context context) {
	...
	private void init() {
		...
		Drawable mDrawable = mContext.getResources().getDrawable(R.drawable.ic_launcher);
